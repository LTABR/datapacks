...
execute if score .seekers_regeneration Opcoes matches 0..9 run scoreboard players remove .seekers_regeneration Opcoes 1
execute if score .seekers_regeneration Opcoes matches -1 run scoreboard players set .seekers_regeneration Opcoes 11
