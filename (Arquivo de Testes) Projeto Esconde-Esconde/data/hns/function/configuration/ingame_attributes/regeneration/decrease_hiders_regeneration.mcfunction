...
execute if score .hiders_regeneration Opcoes matches 0..9 run scoreboard players remove .hiders_regeneration Opcoes 1
execute if score .hiders_regeneration Opcoes matches -1 run scoreboard players set .hiders_regeneration Opcoes 11
