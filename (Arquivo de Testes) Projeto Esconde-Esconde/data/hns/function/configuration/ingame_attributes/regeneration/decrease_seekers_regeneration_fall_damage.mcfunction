...
execute if score .seekers_regeneration_fall_damage Opcoes matches 0..9 run scoreboard players remove .seekers_regeneration_fall_damage Opcoes 1
execute if score .seekers_regeneration_fall_damage Opcoes matches -1 run scoreboard players set .seekers_regeneration_fall_damage Opcoes 11
