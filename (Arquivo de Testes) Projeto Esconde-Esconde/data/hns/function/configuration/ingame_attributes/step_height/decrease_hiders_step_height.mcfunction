...
execute if score .hiders_step_height Opcoes matches 1.. run scoreboard players remove .hiders_step_height Opcoes 1

execute store result storage options hiders.step_height double 0.1 run scoreboard players get .hiders_step_height Opcoes
