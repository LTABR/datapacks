...
execute if score .hiders_speed Opcoes matches 5.. run scoreboard players remove .hiders_speed Opcoes 5

execute store result storage options hiders.speed double 0.001 run scoreboard players get .hiders_speed Opcoes
