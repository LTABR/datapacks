...
execute if score .seekers_scale Opcoes matches 10.. run scoreboard players remove .seekers_scale Opcoes 5

execute store result storage options seekers.scale double 0.01 run scoreboard players get .seekers_scale Opcoes
