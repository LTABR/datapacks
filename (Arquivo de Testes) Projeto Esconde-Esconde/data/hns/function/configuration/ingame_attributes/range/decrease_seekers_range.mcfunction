...
execute if score .seekers_range Opcoes matches 5.. run scoreboard players remove .seekers_range Opcoes 5

execute store result storage options seekers.range double 0.1 run scoreboard players get .seekers_range Opcoes
