...
summon minecraft:firework_rocket ~ ~5 ~ {LifeTime: 25, FireworksItem: {id: "minecraft:firework_rocket", Count: 1b, tag: {Fireworks: {Flight: 1b, Explosions: [{Type: 0, Trail: 1b, Colors: [I; 16711680], FadeColors: [I; 16777215]}, {Type: 4, Colors: [I; 16711680], Flicker: 1b, FadeColors: [I; 16777215]}, {Type: 1, Trail: 1b, Colors: [I; 16711680], FadeColors: [I; 16777215]}]}}}}
